                    ...
                    <tbody>
                        @forelse ($barangs as $item)
                            <tr>
                                ...
                                <td><span class="badge bg-primary-subtle text-primary">{{ $item->kategori->nama }}</span></td>
                                <td>
                                    @if($item->stok > 10)
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <p class="text-muted">Silahkan tambahkan barang baru dengan mengklik tombol "Tambah Barang"</p>
