...
@section('content')
    <div class="container-fluid p-0">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold text-dark m-0"><i class="bi bi-pencil-square me-2"></i>Edit Barang</h2>
                <p class="text-muted">Perbarui data barang dalam inventaris</p>
            </div>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('barang.update', $barang->id) }}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <small class="text-muted">Format: JPG, PNG, JPEG. Maks: 2MB. Kosongkan jika tidak ingin
                                    mengubah foto.</small>
                            </div>
