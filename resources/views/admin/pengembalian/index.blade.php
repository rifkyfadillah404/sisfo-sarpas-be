                    ...
                    <div class="col-md-3">
                        <div class="input-group">
                            ...
                            <select name="status" class="form-select border-start-0 ps-0">
                                ...
                                <option value="complete" {{ request('status') == 'complete' ? 'selected' : '' }}>Selesai
                                </option>
                        ...
                        <tbody>
                            @forelse($pengembalians as $pengembalian)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-secondary-subtle text-dark">{{ $pengembalian->jumlah_dikembalikan }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        @if ($pengembalian->kondisi)
                                            <span class="small text-truncate" data-bs-toggle="tooltip"
                                                title="{{ $pengembalian->kondisi }}">
